                ...
                <div class="dashboard_content_main">
                    <div class="row">
                        <div class="column column-5">
                            <h1 class="section_header"><i class="fa-solid fa-file-invoice"></i> Add Transaction</h1>
                            <div id="userAddFormContainer">
                                    <form action="database/add-transaction.php" method="POST" class="appForm"  >
                                        <div class="appFormInputContainer">
                                            <label for="order_id"> Order ID </label>
                                            <input type="int" class="appFormInput" id="order_id" name="order_id" />
                                        </div> 
                                        ...
                                        <div class="appFormInputContainer">
                                            ...
                                            <input type="int" class="appFormInput" id="emp_id" name="emp_id" />
                                        </div>
                                        <!-- <input type="hidden" name="table" value="login_info" /> -->
                                        <button type="submit" class="appBTn"> <i class="fa-solid fa-money-bill-wave"></i> Add Transaction</button>
                                    </form>
                                    <?php
                                ...
                                <div class="users">
                                    <table>
                                        ...
                                        <tbody>
                                            <?php
                                            $employee = include('database/show-employee.php');
                                             foreach($employee as $index => $user) {?>
                                            <tr>
